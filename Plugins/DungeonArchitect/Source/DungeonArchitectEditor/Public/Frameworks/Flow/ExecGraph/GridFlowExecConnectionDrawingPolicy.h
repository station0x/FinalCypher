...
class DUNGEONARCHITECTEDITOR_API FGridFlowExecConnectionDrawingPolicy : public FConnectionDrawingPolicy {
protected:
    UEdGraph* GraphObj;
...
public:
    //
    FGridFlowExecConnectionDrawingPolicy(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor,
