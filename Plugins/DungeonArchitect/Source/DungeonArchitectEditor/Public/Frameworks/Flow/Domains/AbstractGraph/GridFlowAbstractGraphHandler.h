...
DECLARE_DELEGATE_RetVal_OneParam(FReply, FAbstractGraphDelegate, TWeakObjectPtr<UGridFlowAbstractEdGraph>);
DECLARE_DELEGATE_OneParam(FAbstractGraphChangedDelegate, TWeakObjectPtr<UGridFlowAbstractEdGraph>);
...
class FGridFlowAbstractGraphHandler : public TSharedFromThis<FGridFlowAbstractGraphHandler> {
public:
    void Bind();
