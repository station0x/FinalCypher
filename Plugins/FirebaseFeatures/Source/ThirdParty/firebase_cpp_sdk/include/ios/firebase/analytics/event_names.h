...
/// purchase offer to a user. Add this event to a funnel with the @c
/// AnalyticsEventAddToCart and @c AnalyticsEventEcommercePurchase to
/// gauge your conversion process. Note: If you supply the @c
/// AnalyticsParameterValue parameter, you must also supply the @c
/// AnalyticsParameterCurrency parameter so that revenue metrics can be
/// computed accurately. Params:
///
...
/// purchase was refunded. Note: If you supply the @c
/// AnalyticsParameterValue parameter, you must also supply the @c
/// AnalyticsParameterCurrency parameter so that revenue metrics can be
/// computed accurately. Params:
///
